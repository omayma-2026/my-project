...
st.markdown("---")
st.caption(f"ORMVA-TF Risk & Audit Center · Données réelles : {len(RISQUES)} risques, {len(ALL_PROCESSUS)} processus · Interface de consultation — Prototype PFA Audit Interne & Actuariat")# -*- coding: utf-8 -*-
"""
ORMVA-TF Risk & Audit Center
Application web de consultation et d'exploration des résultats du modèle
d'aide à la décision pour la priorisation des missions d'audit interne.
